                        ...
                        <div>
                            ...
                            <div class="text-lg space-y-6">
                               {{$listings->description}}
                                ...
                                <a href="mailto:{{$listings->email}}" class="block bg-laravel text-white mt-6 py-2 rounded-xl hover:opacity-80"><i class="fa-solid fa-envelope"></i>Contact Employer</a>
                                <a
